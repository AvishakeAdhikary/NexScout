...
GUARDRAIL_PROMPT = (
    ...
    "4. After navigate, call read_page before clicking or filling anything. On any application FORM, call "
    "autofill ONCE first — it deterministically fills the standard fields (name/email/phone/LinkedIn/GitHub "
    "and the résumé file) from the profile — then only handle the remaining custom questions yourself.\n"
